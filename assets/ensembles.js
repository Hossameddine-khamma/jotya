...
var $addNewItem = $('<a href="#" class="text-cyan text-sm px-3 py-1 ">ajouter un produits</a>');
// when the page is loaded and ready
$(document).ready(function () {
    // get the collectionHolder, initilize the var by getting the list;
    $collectionHolder = $('#productList');
...
function addNewForm() {
    ...
    var $panel = $('<div class="panel block w-10/12 bg-grey-lighter text-grey-darker border border-red rounded ml-auto mr-8 mb-3"><div class="panel-heading bg-gray-200 p-2 uppercase tracking-wide text-xs font-bold text-black border"></div></div>');
...
function addRemoveButton ($panel) {
    ...
    var $removeButton = $('<a href="#" class="text-red-600 text-sm px-3 py-1 ">Supprimer</a>');
    // appending the removebutton to the panel footer
    var $panelFooter = $('<div class="panel-footer bg-gray-200 p-2 uppercase tracking-wide text-xs  text-black border"></div>').append($removeButton);
